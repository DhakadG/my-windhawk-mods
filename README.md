...
| [taskbar-system-info-fork](mods/taskbar-system-info-fork/) | 1.0.2 | [Yevhenii Starychenko](https://github.com/starychenko) | CPU/GPU/RAM/VRAM monitor with network throughput and an internet-status dot. Real tray/taskbar insertion instead of the original's overlay. |
